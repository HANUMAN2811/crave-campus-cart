      ...
      <div className="bg-gradient-to-r from-brand-orange to-brand-red rounded-xl overflow-hidden mb-8">
        <div className="flex flex-col md:flex-row items-center">
          <div className="p-8 md:p-12 md:w-3/5">
            ...
            <p className="text-white/90 mb-6 text-lg animate-fade-in" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="p-6 md:w-2/5 flex justify-center">
            <div className="w-64 h-64 rounded-full bg-white/20 flex items-center justify-center animate-fade-in" style={{ animationDelay: "0.4s" }}>
              <img
                src="/placeholder.svg"
                alt="Food delivery"
